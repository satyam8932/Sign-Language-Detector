...
with mp_hands.Hands(
    ...
    while cap.isOpened():
        ...
        # Make detections
        cropframe=frame[40:450,0:350]
        # print(frame.shape)
        frame=cv2.rectangle(frame,(0,40),(350,450),255,2)
        ...
        cv2.putText(frame,"Output: -  "+''.join(sentence)+" "+''.join(accuracy), (3,30),cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 255, 255), 1, cv2.LINE_AA)
        # print(sentence)
        # Show to screen
